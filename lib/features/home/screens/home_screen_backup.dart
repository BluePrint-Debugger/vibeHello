...
class HomeScreen extends StatelessWidget {
  ...
  void _showFeedbackDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Share your thoughts, report an issue, or suggest a feature for VibeHello.',
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () {
              ...
              FeedbackService.submitFeedback(context,
                  'VibeHello feedback from user');
              if (!context.mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      return Scaffold(
        backgroundColor: Theme.of(context).extension<AppColorsExt>()?.background ?? Colors.black,
        body: const Center(
...
class _DailyRewardCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Theme.of(context).extension<AppColorsExt>()?.surface ?? Colors.white54,
